...
const Post = (props) => {
    ...
    return (
        <>
            {/* <div className="account-feed__post post island">
                <div className="account-feed__post-header post__header">
                    ...
                    <a href="/" className="account-feed__post-author-link post__author-link">
                        <h4 className="account-feed__post-author post__author">Данила Рапоткин</h4>
                    </a>
                    <a href="/" className="account-feed__post-time-link post__time-link">7 фев в 17:09</a>
                    
                </div>
                <div className="account-feed__post-content post__content">
                    <div className="account-feed__post-content-repost post__content-repost">
                        <div className="account-feed__post-header post__header">
                            <a href="/" className="account-feed__post-ava post__ava">
                                <img src="/img/ourdays-ava.jpg" alt="ava small" className="account-feed__post-ava-pic post__ava-pic" />
                            </a>
                            
                            <a href="/" className="account-feed__post-author-link post__author-link">
                                <h4 className="account-feed__post-author post__author">Our Days</h4>
                            </a>
                            <a href="/" className="account-feed__post-time-link post__time-link">7 фев в 0:49</a>
                        </div>

                        <a href="/" className="post__text-link">
                            <p className="account-feed__post-text post__text">
                                Вышел!🥳🥳🥳🥳
                                Этим хитом мы проводим черту между смутным прошлым и светлым будущим. Делитесь треком со всеми, комментируйте и наслаждайтесь сами.
                        ...
                        <div className="post__media">
                                ...
                                <div className="post__media-pics">
                                    <a href="/" className="post__media-pic-link">
                                        <img src="/img/post1-pic1.jpg" alt="" className="post__media-pic" />
                                    </a>
                                </div>
                                ...
                                <div className="post__media-reachlink">
                                    <div className="post__media-reachlink-cover"></div>
                                    <div className="post__media-reachlink-meta">
                                        <p><a href="/" className="post__media-reachlink-title">Our Days - Через тернии | BandLink</a></p>
                                        <p><a href="/" className="post__media-reachlink-domain">band.link</a></p>
                                    </div>
                                </div>
                        </div>
                    </div>
