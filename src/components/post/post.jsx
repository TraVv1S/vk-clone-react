...
const Post = (props) => {
    ...
    let [likes, setLikes] = useState(+user.posts[num].likes)
        ...
        return (
            <div className="post__media">
                ...
                ? (<div className={classes.media_pics}>
                    <a href="/">
                        <img src={user.posts[num].media.photo} alt="" className={classes.media_pic} />
                    </a>
                </div>)
                : null
                }
                ...
                ? (<div className={classes.media_reachlink}>
                    ...
                    <div className={classes.media_reachlink_meta}>
                        <p><a href={user.posts[num].media.link} className={classes.media_reachlink_title}>Our Days - Через тернии | BandLink</a></p>
                        <p><a href={user.posts[num].media.link}>band.link</a></p>
                    </div>
                </div>)
                : null
                }
    ...
    return (
        <Island>
            <div className={classes.header}>
                ...
                <a href="/" className={classes.time}>{user.posts[num].time}</a>
